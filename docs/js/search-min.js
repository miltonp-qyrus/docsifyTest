        ...
        if ("heading" === e.type && e.depth <= s) {
          ...
          l[c]
            ? l[c].body
              ...
              : ((e.text = h(e)),
                (e.text = f(e)),
                (l[c].body = l[c].body ? l[c].body + e.text : e.text))
    ...
    s.length && o && i.pathNamespaces
      ? ((n = s[0]),
        Array.isArray(i.pathNamespaces)
          ...
          : i.pathNamespaces instanceof RegExp &&
            (d = n.match(i.pathNamespaces)) &&
            (c = d[0]),
        (e = -1 === s.indexOf(c + "/")),
  ...
  function c(e) {
    ...
    if (!e)
      return (
        ...
        (t.innerHTML = ""),
        void (
          o.hideOtherSidebarContent &&
          (i.classList.remove("hide"), n.classList.remove("hide"))
        )
      );
    var e = (function (e) {
        var n = [],
    ...
    e.forEach(function (e) {
      ...
      o.hideOtherSidebarContent &&
        (i.classList.add("hide"), n.classList.add("hide"));
  }
  function d(e) {
    o = e;
  }
  ...
  $docsify.plugins = [].concat(function (e, n) {
    ...
    Array.isArray(a)
      ...
      : "object" == typeof a &&
        ...
        (v.hideOtherSidebarContent =
          a.hideOtherSidebarContent || v.hideOtherSidebarContent),
